...
public class BaseTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE_BASE
			+ "(" + COLUMN_ID + " integer primary key autoincrement, "
			+ COLUMN_CATEGORY + " text not null, " + COLUMN_WORD
			+ " text not null," + COLUMN_DEFINITION + " text not null" + ");";
